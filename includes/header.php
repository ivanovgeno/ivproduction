...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/app.css?v=20260622-signature3">
    <link rel="stylesheet" href="/assets/css/cinematic.css?v=20260622-signature3">
    <link rel="stylesheet" href="/assets/css/forms-services.css?v=20260622-signature3">
    <link rel="stylesheet" href="/assets/css/signature-v3.css?v=20260622-signature3">
</head>
...
<header class="site-header" data-header>
    <div class="container header-inner">
        ...
        <nav class="main-nav" id="main-nav" data-menu>
            ...
            <a class="<?= is_active('plesy') ? 'active' : '' ?>" href="/plesy">Eventy</a>
            <a class="<?= is_active('fotobudka') ? 'active' : '' ?>" href="/fotobudka">Fotobudka</a>
            <a class="<?= is_active('360budka') ? 'active' : '' ?>" href="/360budka">360°</a>
            <a class="<?= is_active('portfolio') ? 'active' : '' ?>" href="/portfolio">Portfolio</a>
            <a class="button button-small gold-button" href="/kontakt"><span>Poptat projekt</span></a>
        </nav>
    </div>
</header>
<main>
