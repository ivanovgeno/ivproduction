...
header("Content-Security-Policy: default-src 'self'; img-src 'self' data: blob:; style-src 'self' 'unsafe-inline'; font-src 'self'; script-src 'self'; connect-src 'self'; frame-src 'self'; base-uri 'self'; form-action 'self'");
...
function ivp_pages(): array
{
    $labels = [
        ...
        'ivshop.html' => 'IV shop – svatební doplňky',
        'blog.html' => 'Blog',
        'l/planovani-svatby-cim-zacit/index.html' => 'Původní článek: plánování svatby',
        'l/vyber-svatebniho-mista/index.html' => 'Původní článek: výběr svatebního místa',
        'l/typy-svatebniho-obradu/index.html' => 'Původní článek: typy svatebního obřadu',
        'l/dodavatele-aneb-koho-vsechno-potrebujete-na-sve-svatbe/index.html' => 'Původní článek: svatební dodavatelé',
        'l/instax-nebo-fotokoutek-tot-otazka/index.html' => 'Původní článek: Instax nebo fotokoutek',
