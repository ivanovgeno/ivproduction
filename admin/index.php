...
<div class="admin-shell">
    ...
    <main class="workspace">
        ...
        <section class="view" data-panel="videos">
            <div class="view-heading"><div><h2>Portfolio</h2><p id="portfolioCount">Načítám projekty…</p><small class="view-help">Zaškrtnutím „Homepage“ vyberete až 6 realizací do sekce Vybrané realizace. Název, náhled i video se vždy použijí přímo z tohoto projektu.</small></div><button class="button primary" id="addVideo">＋ Přidat video</button></div>
            <div class="list-toolbar"><label class="search-control"><span>⌕</span><input id="portfolioSearch" type="search" placeholder="Hledat projekt…"></label><select id="portfolioFilter"><option value="">Všechny kategorie</option></select><button class="button ghost" id="saveVideos" disabled>Uložit výběr a pořadí</button></div>
...
<script src="assets/admin-social-sharing-20260903.js?v=all-prices-20260918"></script>
